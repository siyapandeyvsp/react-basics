...
const ConditionalRendering = () => {
    return (
        <div>
            ...
            <PackingList />
            <p className='question'><b>Challenge 2 of 3:</b> Show the item importance with &&
            ...
            <p className='question'><b>Challenge 3 of 3:</b> Refactor a series of ? : to if and variables
