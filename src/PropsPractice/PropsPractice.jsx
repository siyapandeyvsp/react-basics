...
const PropsPractice = () => {
  return (
    <div>
      ...
      <p className='question'><b>Challenge 1 of 3:</b> Extract a component
      ...
      <p className='question'><b>Challenge 2 of 3:</b> Adjust the image size based on a prop
      ...
      <p className='question'><b>Challenge 3 of 3:</b> Passing JSX in a children prop
