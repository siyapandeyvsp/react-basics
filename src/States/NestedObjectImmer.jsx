...
const NestedObjectImmer = () => {
  ...
  const handleSpeciesChange = (e) => {
   updatePerson(draft=>{
    draft.characteristics.species=e.target.value
   })
  };
  const handleGenderChange = (e) => {
    updatePerson(draft=>{
        draft.characteristics.gender=e.target.value
    })
  };
  const handleOccupationChange = (e) => {
   updatePerson(draft=>{
    draft.characteristics.occupation=e.target.value
   }
)
  };
  return (
...
export default NestedObjectImmer;
